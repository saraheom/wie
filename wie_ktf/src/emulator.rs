...
impl KtfEmulator {
    ...
    fn load(
        ...
        if inotia1_exp_diag_available {
            // Phase 8.52 stabilization: keep the proven EXP/entity diagnostic engine
            ...
            tracing::info!(
                "[PHASE8_52_RUNTIME_SENTINEL] WIPI Player Phase 8.52 active; stabilized global Inotia1 reward overflow repair + enhancement-scroll/bulk-resource cash catalog"
            );
            tracing::info!(
                "[PHASE8_52_INOTIA1_REWARD_REPAIR_ACTIVE] automatic global monster reward wide-math repair enabled for the verified Inotia1 constructor path"
            );
        }
